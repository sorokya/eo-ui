import{j as m}from"./iframe-N9dek2qS.js";import"./preload-helper-PPVm8Dsz.js";const u="_panel_kv33y_1",h="_medium_kv33y_10",b="_bold_kv33y_14",r={panel:u,medium:h,bold:b};function i({children:s,borderStyle:o="thin",padding:d="4px",backgroundOpacity:l=.5,bold:p=!1}){const c=o==="medium"?r.medium:"";return m.jsx("div",{className:`${r.panel} ${c} ${p?r.bold:""}`,style:{"--eo-ui-panel-padding":d,"--eo-ui-panel-background-opacity":l},children:s})}i.__docgenInfo={description:"",methods:[],displayName:"Panel",props:{children:{required:!0,tsType:{name:"ReactNode"},description:"Content to be displayed inside the panel."},borderStyle:{required:!1,tsType:{name:"union",raw:"'thin' | 'medium'",elements:[{name:"literal",value:"'thin'"},{name:"literal",value:"'medium'"}]},description:`Style of the panel border, either 'thin' or 'medium'
