import{m as t}from"./iframe-B13H1NF8.js";import"./preload-helper-PPVm8Dsz.js";const u="_button_1s9sk_1",c="_large_1s9sk_43",r={button:u,large:c};function n({children:s,variant:o="small",type:l="button",onClick:i=()=>{}}){return t.jsx("button",{type:l,className:`${r.button} ${o==="large"?r.large:""}`,onClick:i,children:t.jsx("span",{children:s})})}n.__docgenInfo={description:"",methods:[],displayName:"Button",props:{children:{required:!0,tsType:{name:"string"},description:"The string content of the button"},variant:{required:!1,tsType:{name:"union",raw:"'small' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'large'"}]},description:`The variant of the button, either 'small' or 'large'
...
}`,...a.parameters?.docs?.source}}};const g=["Default","Large"];export{e as Default,a as Large,g as __namedExportsOrder,p as default};
